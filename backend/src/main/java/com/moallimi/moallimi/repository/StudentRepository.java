...
public interface StudentRepository extends JpaRepository<Student, Long> {
        ...
        @Query("SELECT new com.moallimi.moallimi.payload.dto.AcademicLevelStudentCountDTO(a.name, COUNT(s)) " +
                        "FROM Student s JOIN s.academicLevel a " +
                        "GROUP BY a.name")
        List<AcademicLevelStudentCountDTO> countStudentsByAcademicLevel();
}
