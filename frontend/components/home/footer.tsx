                    ...
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-8 sm:w-2/3 lg:w-3/12">
                            <div className="mb-10 w-full">
                                <a href="/#" className="mb-6 inline-block max-w-[160px] text-primaryText font-bold text-5xl">
                                    MyLogo
                                </a>
                        ...
                        <LinkGroup header="Company">
                            <NavLink link="/#" label="About MyLogo" />
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                            <div className="mb-10 w-full">
                                ...
                                <p className="text-base text-body-color dark:text-dark-6">&copy; 2025 MyLogo</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    return (
        <>
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div className="mb-10 w-full">
                    <h4 className="mb-9 text-lg font-semibold text-primaryText ">{header}</h4>
...
const NavLink = ({ link, label }: any) => {
    return (
        <li>
            <a href={link} className="inline-block text-base leading-loose text-body-color hover:text-primary">
                {label}
            </a>
        </li>
    );
