...
import { ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ClockIcon } from '@heroicons/react/24/solid';
...
const days = [
    ...
    { date: '2022-01-11', isCurrentMonth: true, events: [] },
    {
        ...
        isCurrentMonth: true,
        isToday: true,
        events: [{ id: 6, name: 'TCP/IP', time: '2PM', datetime: '2022-01-25T14:00', href: '#' }]
    },
    ...
    { date: '2022-01-21', isCurrentMonth: true, events: [] },
    {
        ...
        isSelected: true,
        events: [
            { id: 4, name: 'Statistic descriptive', time: '3PM', datetime: '2022-01-22T15:00', href: '#' },
            { id: 5, name: 'Python POO', time: '7PM', datetime: '2022-01-22T19:00', href: '#' }
        ]
    },
                        ...
                        {days.map((day) => (
                            ...
                            key={day.date}
                                className={classNames(
                                    day.isToday ? 'bg-lightPrimary' : (day.isCurrentMonth ? 'bg-white' : 'bg-gray-50 text-gray-500'),
                                    'relative py-2 px-3'
                                )}
                            >
                                <time
