...
export function NewPost() {
    const [postOptionsOpened, setPostOptionsOpened] = useState(false);

    const openPostOptions = (val: boolean) => {
        setPostOptionsOpened(val);
    };
            ...
            <div className="flex space-x-2">
                ...
                <div className="mb-6 flex-auto">
                    <textarea
                        id="postContent"
                        name="postContent"
                        onFocus={() => openPostOptions(true)}
                        onBlur={() => openPostOptions(false)}
            ...
            {postOptionsOpened && (
                <div>
                    <div className="mb-6">
                        ...
                        <div className="relative border-2 rounded-md px-4 py-3 bg-white flex items-center justify-between hover:border-darkPrimary transition duration-150 ease-in-out">
                            <input
                                type="file"
                                id="fileAttachment"
                                name="fileAttachment"
                    ...
                    <div className="mb-6">
                        ...
                        <div className="relative border-2 rounded-md px-4 py-3 bg-white flex items-center justify-between hover:border-darkPrimary transition duration-150 ease-in-out">
                            <input type="datetime-local" id="datePost" name="datePost" className="outline-none w-full cursor-pointer" />
                        </div>
                    </div>
